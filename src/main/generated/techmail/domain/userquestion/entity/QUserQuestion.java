...
public class QUserQuestion extends EntityPathBase<UserQuestion> {
    ...
    public final techmail.domain.question.entity.QQuestion question;

    //inherited
    public final DateTimePath<java.time.LocalDateTime> updatedAt = _super.updatedAt;

    public final techmail.domain.user.entity.QUser user;
    ...
    public QUserQuestion(Class<? extends UserQuestion> type, PathMetadata metadata, PathInits inits) {
        ...
        this.question = inits.isInitialized("question") ? new techmail.domain.question.entity.QQuestion(forProperty("question")) : null;
        this.user = inits.isInitialized("user") ? new techmail.domain.user.entity.QUser(forProperty("user")) : null;
    }
